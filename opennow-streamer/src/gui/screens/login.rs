                ...
                .show(ui, |ui| {
                    ...
                    ui.vertical(|ui| {
                        ...
                        ui.horizontal(|ui| {
                            ...
                            let selected_name = login_providers
                        ...
                        ui.with_layout(egui::Layout::top_down(egui::Align::Center), |ui| {
                            if is_loading {
                                ...
                                ui.add_space(12.0);
                                ui.label(
                                    egui::RichText::new("Waiting for login...")
                                        .size(13.0)
                                ...
                                // Show login URL with copy button if browser didn't open
                                if let Some(url) = login_url {
                                    ...
                                    ui.label(
                                        egui::RichText::new("Browser didn't open? Copy this link:")
                                            .size(11.0)
                                            .color(egui::Color32::from_rgb(180, 180, 180)),
                                    );
                                    ...
                                    // URL text box (read-only, selectable)
                                    let mut url_text = url.to_string();
                                    let text_edit = egui::TextEdit::singleline(&mut url_text)
                                    ...
                                    if ui.add_sized([120.0, 28.0], copy_btn).clicked() {
                                    ...
                                    ui.label(
                                        egui::RichText::new(
                                            "Paste this URL in your browser to login",
                                        )
                                        .size(10.0)
